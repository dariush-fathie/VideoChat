package ir.jin724.videochat.view;
...
public final class WebRtcAnswerDeclineButton extends LinearLayout implements AccessibilityManager.TouchExplorationStateChangeListener {
  ...
  private void createView(boolean isTouchExplorationEnabled) {
    if (isTouchExplorationEnabled) {
      inflate(getContext(), R.layout.answer_decline_accessible, this);
      ...
      inflate(getContext(), R.layout.answer_decline, this);
      ...
      switch (event.getAction()) {
        ...
        case MotionEvent.ACTION_UP:
          ...
          if (Build.VERSION.SDK_INT >= 21) {
            answer.getDrawable().setTint(getResources().getColor(R.color.green));
        ...
        case MotionEvent.ACTION_MOVE:
          ...
          if (difference <= 0) {
            ...
            backgroundColor       = (int) new ArgbEvaluator().evaluate(percentageToThreshold, getResources().getColor(R.color.green), getResources().getColor(R.color.colorPrimaryDark));

            if (percentageToThreshold > 0.5) {
              foregroundColor = Color.WHITE;
            } else {
              foregroundColor = getResources().getColor(R.color.green);
            }
            ...
            backgroundColor = (int) new ArgbEvaluator().evaluate(percentageToThreshold, getResources().getColor(R.color.red), getResources().getColor(R.color.colorPrimary));
